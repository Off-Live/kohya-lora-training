...
def main(args):
    ...
    model = blip_decoder(pretrained=args.caption_weights, image_size=IMAGE_SIZE, vit="large", med_config=args.med_config)
    model.eval()
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--med_config", type=str, help="med_config file")
    return parser
